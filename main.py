...
schedulerD = ReduceLROnPlateau(optimizerD, mode='min', factor=0.02, patience=215, verbose=True)
schedulerG = ReduceLROnPlateau(optimizerG, mode='min', factor=0.02, patience=215, verbose=True)
